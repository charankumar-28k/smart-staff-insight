        ...
        <AuthProvider>
          <CollegeProvider>
            <Routes>
              ...
              <Route path="/staff/academic" element={<ProtectedRoute allowedRole="ROLE_STAFF"><StaffAcademicProgress /></ProtectedRoute>} />
              ...
              <Route path="/hod/departments" element={<ProtectedRoute allowedRole="ROLE_HOD"><HodDepartments /></ProtectedRoute>} />
              <Route path="/hod/academic" element={<ProtectedRoute allowedRole="ROLE_HOD"><HodAcademicProgress /></ProtectedRoute>} />
