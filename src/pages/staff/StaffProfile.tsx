...
const StaffProfile: React.FC = () => {
  ...
  const profileFields = [
    ...
    { label: "Role", value: user?.role === "ROLE_HOD" ? "Head of Department" : "Staff Member", icon: Award },
    { label: "Subject", value: "Data Structures", icon: BookOpen },
    { label: "Joining Date", value: "August 2022", icon: CalendarCheck },
  ];
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <span className="inline-block mt-2 text-xs px-3 py-1 rounded-full bg-primary/10 text-primary font-medium">
              {user?.role === "ROLE_HOD" ? "Head of Department" : "Staff Member"}
            </span>
          </div>
        </div>
